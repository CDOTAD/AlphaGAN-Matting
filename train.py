...
def parse_args():
    ...
    parser.add_argument('--dataroot', type=str, default='/data1/zzl/dataset/Combined_Dataset/Training_set', help='Training data root')
    parser.add_argument('--training_file', type=str, default='/data1/zzl/dataset/Combined_Dataset/Training_set/training_set.txt')
    parser.add_argument('--bg_root', type=str, default='/data1/zzl/dataset/mscoco/train2014')
    parser.add_argument('--epoch', type=int, default=100000, help='The number of epochs to run (default: 1000)')
    parser.add_argument('--warmup_step', type=int, default=500)
    parser.add_argument('--batch_size', type=int, default=1, help='The size of batch (default: 4)')

    parser.add_argument('--save_model', type=str2bool, nargs='?', default=True)
    parser.add_argument('--save_dir', type=str, default='/data1/zzl/checkpoint/alphaGAN', help='Directory name to save the model')
    parser.add_argument('--gpu_mode', type=str2bool, nargs='?', default=True, help='Use gpu mode (default: True)')
    parser.add_argument('--device', type=str, default='0, 1', help='The cuda device that to be used (defult: 0)')
    parser.add_argument('--gan', type=str2bool, nargs='?', default=True, help='Whether to use Discrimator (default: True)')

    parser.add_argument('--lrG', type=float, default=4e-4, help='The learning rate of G (default: 0.0002)')
    parser.add_argument('--lrD', type=float, default=4e-4, help='The learning rate of D (default: 0.0002)')
